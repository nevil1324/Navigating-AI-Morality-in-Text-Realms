...
def main(args):
    ...
    for run in range(args.nruns):
        model, optimizer = load_model(args , load_path='virtue_bert-base-multilingual-cased_2e-05_16_2.pkl')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", "-m", type=str, default="bert-base-multilingual-cased")
